...
const RookGamePage = () => {
  ...
  const [playerRole, setPlayerRole] = useState("rook");
  ...
  const renderMainUI = () => {
    ...
    return (
      <div className="relative flex flex-col items-center my-6">
        ...
        <h4 className="text-sm font-bold mb-4">Disabled: {`${gameState?.players?.rook?.disabled}`}</h4>
